...
export PYSERVICELIB_SOURCE_CONTEXT ?= $(SERVICEGEN_DEPENDENCY_PROXY_DOCKER_BASE)/github-raw/gorundebug/pyservicelib/archive/refs/tags/v0.2.12.tar.gz
...
git-push-analyticsservice: $(GH) ## Push service Analytics Service to github.com/gorundebug/pyexample-analyticsservice
	$(call git-push-dir,analyticsservice,$(MODULE_VERSION),github.com,gorundebug/pyexample-analyticsservice,python-service)

git-delete-analyticsservice: $(GH) ## Delete service Analytics Service from remote
	@$(GH) repo delete gorundebug/pyexample-analyticsservice --yes 2>/dev/null || true


git-push-automationservice: $(GH) ## Push service Automation Service to github.com/gorundebug/pyexample-automationservice
	$(call git-push-dir,automationservice,$(MODULE_VERSION),github.com,gorundebug/pyexample-automationservice,python-service)

git-delete-automationservice: $(GH) ## Delete service Automation Service from remote
	@$(GH) repo delete gorundebug/pyexample-automationservice --yes 2>/dev/null || true
