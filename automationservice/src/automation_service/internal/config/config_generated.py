...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "streams": { "activityPause": StreamConfig(duration=250, functionDescription="Apply the ordinary local Delay while processing an on-demand Temporal Activity.\n", functionInitializerGroup="", functionModule="", functionName="ActivityPause", functionPackage="", id=3, idService=2, idSource=9, name="Activity Pause", pipeline="automation", type=TransformationType(16), xPos=-250, yPos=350, ), "callFanOutActivityA": StreamConfig(id=4, idEndpoint=6, idService=2, idSource=13, name="Call Fan-Out Activity A", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=-250, yPos=1870, ), "callFanOutActivityB": StreamConfig(id=5, idEndpoint=7, idService=2, idSource=33, name="Call Fan-Out Activity B", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=270, yPos=1790, ), "callFanOutActivityC": StreamConfig(id=6, idEndpoint=8, idService=2, idSource=33, name="Call Fan-Out Activity C", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=270, yPos=1950, ), "callSequentialActivityA": StreamConfig(id=7, idEndpoint=10, idService=2, idSource=40, name="Call Sequential Activity A", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=10, yPos=650, ), "callSequentialActivityB": StreamConfig(id=8, idEndpoint=11, idService=2, idSource=7, name="Call Sequential Activity B", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=270, yPos=650, ), "consumeActivityJob": StreamConfig(id=9, idEndpoint=5, idService=2, idSource=22, name="Consume Activity Job", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=350, ), "consumeFanOutActivityA": StreamConfig(id=10, idEndpoint=6, idService=2, idSource=23, name="Consume Fan-Out Activity A", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=2120, ), "consumeFanOutActivityB": StreamConfig(id=11, idEndpoint=7, idService=2, idSource=24, name="Consume Fan-Out Activity B", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=2270, ), "consumeFanOutActivityC": StreamConfig(id=12, idEndpoint=8, idService=2, idSource=25, name="Consume Fan-Out Activity C", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=2420, ), "consumeFanOutWorkflowJob": StreamConfig(id=13, idEndpoint=9, idService=2, idSource=0, name="Consume Fan-Out Workflow Job", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=1870, ), "consumeSequentialActivityA": StreamConfig(id=14, idEndpoint=10, idService=2, idSource=28, name="Consume Sequential Activity A", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=1570, ), "consumeSequentialActivityB": StreamConfig(id=15, idEndpoint=11, idService=2, idSource=29, name="Consume Sequential Activity B", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=1720, ), "consumeWorkflowJob": StreamConfig(id=16, idEndpoint=14, idService=2, idSource=30, name="Consume Workflow Job", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-500, yPos=650, ), "localSchedule": StreamConfig(id=17, idEndpoint=2, idService=2, idSource=0, name="Local Schedule", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-1250, yPos=500, ), "observeActivityResult": StreamConfig(functionDescription="Preserve the result returned through the on-demand Activity endpoint.\n", functionInitializerGroup="", functionModule="", functionName="ObserveActivityResult", functionPackage="", id=18, idService=2, idSource=35, name="Observe Activity Result", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-500, yPos=500, ), "observeFanOutActivityB": StreamConfig(functionDescription="Observe the typed result returned by the Activity B fan-out branch.\n", functionInitializerGroup="", functionModule="", functionName="ObserveFanoutActivityB", functionPackage="", id=19, idService=2, idSource=5, name="Observe Fan-Out Activity B", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=530, yPos=1790, ), "observeFanOutActivityC": StreamConfig(functionDescription="Observe the typed result returned by the Activity C fan-out branch.\n", functionInitializerGroup="", functionModule="", functionName="ObserveFanoutActivityC", functionPackage="", id=20, idService=2, idSource=6, name="Observe Fan-Out Activity C", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=530, yPos=1950, ), "observeWorkflowResult": StreamConfig(functionDescription="Preserve the result returned through the on-demand Workflow endpoint.\n", functionInitializerGroup="", functionModule="", functionName="ObserveWorkflowResult", functionPackage="", id=21, idService=2, idSource=37, name="Observe Workflow Result", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-500, yPos=800, ), "processActivityJob": StreamConfig(functionDescription="Record Activity progress with DurableCallHeartbeat and return the processed job result.\n", functionInitializerGroup="", functionModule="", functionName="ProcessActivityJob", functionPackage="", id=22, idService=2, idSource=3, name="Process Activity Job", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=10, yPos=350, ), "processFanOutActivityA": StreamConfig(functionDescription="Return Activity A's typed result before the Workflow Split.\n", functionInitializerGroup="", functionModule="", functionName="ProcessFanoutActivityA", functionPackage="", id=23, idService=2, idSource=10, name="Process Fan-Out Activity A", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=2120, ), "processFanOutActivityB": StreamConfig(functionDescription="Return Activity B's typed fan-out result.\n", functionInitializerGroup="", functionModule="", functionName="ProcessFanoutActivityB", functionPackage="", id=24, idService=2, idSource=11, name="Process Fan-Out Activity B", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=2270, ), "processFanOutActivityC": StreamConfig(functionDescription="Return Activity C's typed fan-out result.\n", functionInitializerGroup="", functionModule="", functionName="ProcessFanoutActivityC", functionPackage="", id=25, idService=2, idSource=12, name="Process Fan-Out Activity C", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=2420, ), "processScheduledActivity": StreamConfig(functionDescription="Return the visible result of one scheduled Activity execution.\n", functionInitializerGroup="", functionModule="", functionName="ProcessScheduledActivity", functionPackage="", id=26, idService=2, idSource=31, name="Process Scheduled Activity", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=1010, ), "processScheduledWorkflow": StreamConfig(functionDescription="Return the visible result of one scheduled Workflow execution.\n", functionInitializerGroup="", functionModule="", functionName="ProcessScheduledWorkflow", functionPackage="", id=27, idService=2, idSource=32, name="Process Scheduled Workflow", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=1310, ), "processSequentialActivityA": StreamConfig(functionDescription="Return sequential Activity A's typed result to its Temporal sink.\n", functionInitializerGroup="", functionModule="", functionName="ProcessSequentialActivityA", functionPackage="", id=28, idService=2, idSource=14, name="Process Sequential Activity A", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=1570, ), "processSequentialActivityB": StreamConfig(functionDescription="Return sequential Activity B's typed result to its Temporal sink.\n", functionInitializerGroup="", functionModule="", functionName="ProcessSequentialActivityB", functionPackage="", id=29, idService=2, idSource=15, name="Process Sequential Activity B", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=-250, yPos=1720, ), "processWorkflowJob": StreamConfig(functionDescription="Continue the Workflow as new once, then return its final result.\n", functionInitializerGroup="", functionModule="", functionName="ProcessWorkflowJob", functionPackage="", id=30, idService=2, idSource=8, name="Process Workflow Job", pipeline="automation", type=TransformationType(2), valueType="AutomationJob", xPos=530, yPos=650, ), "scheduledActivityPause": StreamConfig(duration=250, functionDescription="Apply the ordinary local Delay inside an Activity started by Temporal Schedule.\n", functionInitializerGroup="", functionModule="", functionName="ScheduledActivityPause", functionPackage="", id=31, idService=2, idSource=38, name="Scheduled Activity Pause", pipeline="automation", type=TransformationType(16), xPos=-500, yPos=1010, ), "scheduledWorkflowPause": StreamConfig(duration=250, functionDescription="Use the official Temporal Workflow timer for a scheduled Workflow.\n", functionInitializerGroup="", functionModule="", functionName="ScheduledWorkflowPause", functionPackage="", id=32, idService=2, idSource=39, name="Scheduled Workflow Pause", pipeline="automation", type=TransformationType(16), xPos=-500, yPos=1310, ), "splitActivityAResult": StreamConfig(id=33, idService=2, idSource=4, name="Split Activity A Result", pipeline="automation", type=TransformationType(11), xPos=10, yPos=1870, ), "splitOnDemandJobs": StreamConfig(id=34, idService=2, idSource=17, name="Split On-Demand Jobs", pipeline="automation", type=TransformationType(11), xPos=-1010, yPos=500, ), "submitActivityJob": StreamConfig(id=35, idEndpoint=5, idService=2, idSource=34, name="Submit Activity Job", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=-760, yPos=350, ), "submitFanOutWorkflowJob": StreamConfig(id=36, idEndpoint=9, idService=2, idSource=34, name="Submit Fan-Out Workflow Job", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=-760, yPos=1870, ), "submitWorkflowJob": StreamConfig(id=37, idEndpoint=14, idService=2, idSource=34, name="Submit Workflow Job", pipeline="automation", type=TransformationType(13), valueType="AutomationJob", xPos=-760, yPos=650, ), "temporalActivitySchedule": StreamConfig(id=38, idEndpoint=12, idService=2, idSource=26, name="Temporal Activity Schedule", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-760, yPos=1010, ), "temporalWorkflowSchedule": StreamConfig(id=39, idEndpoint=13, idService=2, idSource=27, name="Temporal Workflow Schedule", pipeline="automation", type=TransformationType(1), valueType="AutomationJob", xPos=-760, yPos=1310, ), "workflowPause": StreamConfig(duration=250, functionDescription="Use the same Delay contract backed by the Temporal Workflow timer.\n", functionInitializerGroup="", functionModule="", functionName="WorkflowPause", functionPackage="", id=40, idService=2, idSource=16, name="Workflow Pause", pipeline="automation", type=TransformationType(16), xPos=-250, yPos=650, ), },
    ...
    "types": { "automationJob": TypeConfig(description="Automation job payload and result.", name="AutomationJob", publicType=False, type=DataType.string, ), },
}
