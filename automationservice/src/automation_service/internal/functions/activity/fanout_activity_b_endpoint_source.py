...
class FanoutActivityBEndpointSource:
...
async def make_fanout_activity_b_endpoint_source(
    ctx: Context,
    environment: ServiceEnvironment,
    config: TemporalEndpointConfig,
) -> FanoutActivityBEndpointSource:
    """Construct FanoutActivityBEndpointSource for the configured service graph."""
    del ctx, config, environment
    return FanoutActivityBEndpointSource()
