...
class WorkflowJobEndpointSource:
...
async def make_workflow_job_endpoint_source(
    ctx: Context,
    environment: ServiceEnvironment,
    config: TemporalEndpointConfig,
) -> WorkflowJobEndpointSource:
    """Construct WorkflowJobEndpointSource for the configured service graph."""
    del ctx, config, environment
    return WorkflowJobEndpointSource()
