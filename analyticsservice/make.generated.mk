...
lint: init ## Run mypy and Ruff checks
	@uv run mypy --package "analytics_service"
...
docker-build: ## [Docker] Build the autonomous copied-source runtime image
	...
	docker build $$args $(DEPENDENCY_PROXY_DOCKER_ARGS) --target "$(DOCKER_TARGET)" \
	  ...
	  -t "analyticsservice-python:$(DOCKER_IMAGE_TAG)" .

docker-build-dev: ## Build the source-mounted standalone development image
	@$(MAKE) docker-build DOCKER_TARGET="$(DOCKER_DEV_TARGET)"
	@docker tag "analyticsservice-python:$(DOCKER_IMAGE_TAG)" \
	  "analyticsservice-python-development:local"
