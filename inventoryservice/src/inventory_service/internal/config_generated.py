...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "services": { "inventoryService": ServiceConfig(color="#D2E5FF", defaultCallSemantics=CallSemantics(2), defaultGrpcTimeout=0, environment=Environment(""), golangVersion="1.25.4", grpcHost="0.0.0.0", grpcPort=9202, httpHost="0.0.0.0", httpPort=9092, id=1, metricsHandler="metrics", modulePath="github.com/gorundebug/pyexample-inventoryservice", name="Inventory Service", programmingLanguage=ProgrammingLanguage(3), shutdownTimeout=30000, statusHandler="status", ), },
    ...
    "types": { "orderItem": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="A single line item within an order. Fields: OrderID string, ItemID string, SKU string, Quantity int.", module="model", name="OrderItem", publicType=False, transferByValue=False, type=DataType.struct, ), "orderItemResult": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="Inventory reservation result for a single order item. Fields: OrderID string, ItemID string, SKU string, RequestedQty int, AvailableQty int, Reserved bool, Status string (CONFIRMED / OUT_OF_STOCK), UnitPrice float64.", module="model", name="OrderItemResult", publicType=False, transferByValue=False, type=DataType.struct, ), },
}
