...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "getInventoryItemDataToMergeInventoryResult": LinkConfig(callSemantics=CallSemantics(2), var_from=1, to=3, ), "processInventoryItemToGetInventoryItemData": LinkConfig(callSemantics=CallSemantics(2), var_from=4, poolName="Inventory Priority Workers", priority=10, to=1, ), },
