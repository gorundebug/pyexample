...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "getInventoryItemDataToMergeInventoryResult": LinkConfig(callSemantics=CallSemantics(5), var_from=42, to=44, ), "processInventoryItemToGetInventoryItemData": LinkConfig(callSemantics=CallSemantics(4), var_from=45, poolName="Inventory Priority Workers", priority=10, to=42, ), },
