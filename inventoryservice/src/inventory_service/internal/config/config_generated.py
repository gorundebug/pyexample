...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "getInventoryItemDataToMergeInventoryResult": LinkConfig(callSemantics=CallSemantics(5), var_from=73, to=76, ), "processInventoryItemToGetInventoryItemData": LinkConfig(callSemantics=CallSemantics(4), var_from=77, poolName="Inventory Priority Workers", priority=10, to=73, ), },
