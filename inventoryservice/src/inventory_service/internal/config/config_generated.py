...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "getInventoryItemDataToMergeInventoryResult": LinkConfig(callSemantics=CallSemantics(5), var_from=41, to=43, ), "processInventoryItemToGetInventoryItemData": LinkConfig(callSemantics=CallSemantics(3), var_from=44, poolName="Inventory Priority Workers", priority=10, to=41, ), },
