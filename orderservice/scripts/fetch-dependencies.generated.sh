...
fetch_module "inventory_service_api" "https://github.com/gorundebug/pyexample.git" "v0.2.72" "inventory_service_api"
fetch_module "model_python" "https://github.com/gorundebug/pyexample.git" "v0.2.72" "model_python"
fetch_module "order_service_api" "https://github.com/gorundebug/pyexample.git" "v0.2.72" "order_service_api"