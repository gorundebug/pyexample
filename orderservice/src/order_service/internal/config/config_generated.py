...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "mergeResultsToSplitOrderResult": LinkConfig(callSemantics=CallSemantics(2), var_from=82, to=88, ), "processOrderToSplitPipeline": LinkConfig(callSemantics=CallSemantics(3), var_from=83, poolName="Default Pool", priority=1, to=89, ), "splitPipelineToProcessOrderItems": LinkConfig(callSemantics=CallSemantics(5), var_from=89, to=85, ), "splitPipelineToSoftDeadline": LinkConfig(callSemantics=CallSemantics(5), var_from=89, to=87, ), },
