...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "types": { "order": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="E-commerce order submitted by a customer. Fields: ID string, CustomerID string, Items []OrderItem, CreatedAt time.Time.", name="Order", publicType=False, transferByValue=False, type=DataType.struct, ), "orderItem": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="A single line item within an order. Fields: OrderID string, ItemID string, SKU string, Quantity int.", module="model", name="OrderItem", publicType=False, transferByValue=False, type=DataType.struct, ), "orderItemResult": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="Inventory reservation result for a single order item. Fields: OrderID string, ItemID string, SKU string, RequestedQty int, AvailableQty int, Reserved bool, Status string (CONFIRMED / OUT_OF_STOCK / PROCESSING_ERROR), UnitPrice float64, Error string.", module="model", name="OrderItemResult", publicType=False, transferByValue=False, type=DataType.struct, ), "orderProcessed": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="Final order-processing event. Fields: OrderID string, Status string, ProcessedAt time.Time, TotalItems int, ConfirmedItems int, FailureReason string.", module="model", name="OrderProcessed", publicType=False, transferByValue=False, type=DataType.struct, ), "orderState": TypeConfig(definitionFormat=TypeDefinitionFormat(1), description="Processing result of an order. Fields: OrderID string, Status string (CONFIRMED — all items reserved; PARTIALLY_CONFIRMED — some items out of stock; TIMED_OUT — order timed out), ConfirmedItems []OrderItemResult, TotalAmount float64, ProcessedAt time.Time.", name="OrderState", publicType=False, transferByValue=False, type=DataType.struct, ), },
}
...
class StreamIds:
    MAP_ORDER_ITEM_RESULT_TO_ORDER_STATE: Final[int] = 79
    MAP_TO_ORDER_PROCESSED: Final[int] = 80
    MAP_TO_ORDER_STATE: Final[int] = 81
    MERGE_RESULTS: Final[int] = 82
    PROCESS_ORDER: Final[int] = 83
    PROCESS_ORDER_ITEM: Final[int] = 84
    PROCESS_ORDER_ITEMS: Final[int] = 85
    PUBLISH_ORDER_PROCESSED: Final[int] = 86
    SOFT_DEADLINE: Final[int] = 87
    SPLIT_ORDER_RESULT: Final[int] = 88
    SPLIT_PIPELINE: Final[int] = 89


class EndpointIds:
    ORDER_PROCESSED: Final[int] = 14
    PROCESS_ORDER: Final[int] = 15
    PROCESS_ORDER_ITEM: Final[int] = 11


class DataConnectorIds:
    INVENTORY_SERVICE_API: Final[int] = 2
    ORDER_EVENTS: Final[int] = 4
    ORDER_SERVICE_API: Final[int] = 5
