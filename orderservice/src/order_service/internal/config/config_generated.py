...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "mergeResultsToSplitOrderResult": LinkConfig(callSemantics=CallSemantics(2), var_from=50, to=56, ), "processOrderToSplitPipeline": LinkConfig(callSemantics=CallSemantics(3), var_from=51, poolName="Default Pool", priority=1, to=57, ), "splitPipelineToProcessOrderItems": LinkConfig(callSemantics=CallSemantics(5), var_from=57, to=53, ), "splitPipelineToSoftDeadline": LinkConfig(callSemantics=CallSemantics(5), var_from=57, to=55, ), },
