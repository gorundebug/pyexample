...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "links": { "mergeResultsToSplitOrderResult": LinkConfig(callSemantics=CallSemantics(2), var_from=49, to=55, ), "processOrderToSplitPipeline": LinkConfig(callSemantics=CallSemantics(4), var_from=50, poolName="Default Pool", priority=1, to=56, ), "splitPipelineToProcessOrderItems": LinkConfig(callSemantics=CallSemantics(5), var_from=56, to=52, ), "splitPipelineToSoftDeadline": LinkConfig(callSemantics=CallSemantics(5), var_from=56, to=54, ), },
