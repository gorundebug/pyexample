...
class StreamIds:
    MAP_ORDER_ITEM_RESULT_TO_ORDER_STATE: Final[int] = 47
    MAP_TO_ORDER_PROCESSED: Final[int] = 48
    MAP_TO_ORDER_STATE: Final[int] = 49
    MERGE_RESULTS: Final[int] = 50
    PROCESS_ORDER: Final[int] = 51
    PROCESS_ORDER_ITEM: Final[int] = 52
    PROCESS_ORDER_ITEMS: Final[int] = 53
    PUBLISH_ORDER_PROCESSED: Final[int] = 54
    SOFT_DEADLINE: Final[int] = 55
    SPLIT_ORDER_RESULT: Final[int] = 56
    SPLIT_PIPELINE: Final[int] = 57


class EndpointIds:
    ORDER_PROCESSED: Final[int] = 4
    PROCESS_ORDER: Final[int] = 5
