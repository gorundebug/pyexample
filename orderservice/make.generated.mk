...
MODULE_CONTEXT_ARGS =
PYSERVICELIB_SOURCE_CONTEXT ?= https://github.com/gorundebug/pyservicelib.git\#v0.2.134
MODULE_CONTEXT_ARGS += --build-context pyservicelib-source="$(PYSERVICELIB_SOURCE_CONTEXT)"
INVENTORY_SERVICE_API_SOURCE_CONTEXT ?= https://github.com/gorundebug/pyexample.git\#v0.2.134
MODULE_CONTEXT_ARGS += --build-context module-inventory_service_api-source="$(INVENTORY_SERVICE_API_SOURCE_CONTEXT)"
MODEL_PYTHON_SOURCE_CONTEXT ?= https://github.com/gorundebug/pyexample.git\#v0.2.134
MODULE_CONTEXT_ARGS += --build-context module-model_python-source="$(MODEL_PYTHON_SOURCE_CONTEXT)"
ORDER_SERVICE_API_SOURCE_CONTEXT ?= https://github.com/gorundebug/pyexample.git\#v0.2.134
...
PYSERVICELIB_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/pyservicelib.git\#v0.2.134
endif
ifneq ($(strip $(USE_LOCAL_MODULES)),1)
INVENTORY_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/pyexample.git\#v0.2.134
MODEL_PYTHON_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/pyexample.git\#v0.2.134
ORDER_SERVICE_API_SOURCE_CONTEXT := $(DEPENDENCY_GIT_MIRROR_DOCKER_BASE)/github.com/gorundebug/pyexample.git\#v0.2.134
endif
endif
