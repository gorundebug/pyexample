...
```sh
make python-init    # [host]
make python-build   # [host]
make python-test    # [host]
make python-lint    # [host]
make python-format  # [host]
make python-package # [host] package standalone service directories
```
