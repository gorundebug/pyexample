...
| Language | `Python` |
| Kind | `process` |
| File | `analyticsservice/src/analytics_service/internal/functions/count_order_processed.py` |
| Test | `analyticsservice/tests/functions/test_count_order_processed.py` |
...
- [ ] Open `analyticsservice/src/analytics_service/internal/functions/count_order_processed.py` and preserve its generated contract
...
- [ ] Implement meaningful assertions in `analyticsservice/tests/functions/test_count_order_processed.py`
